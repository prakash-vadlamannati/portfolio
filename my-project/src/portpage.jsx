...
function Navbar() {
  return (
    <div className="complete">
      ...
      <nav className="navbar navbar-expand-lg navbar-light containe">
      ...
      <div className="about">
        ...
        <div className="head">
          <h1>Frontend Developer
            Hi, I'm Sai Prakash A passionate frontend developer.</h1>
      ...
      <div className="project-part">
        ...
        <div className="project">
          ...
          <div className="pimg">
            ...
            <img src={food} className="ppim" />
            <p>Tittle: Food Details</p>
          </div>
    ...
    <div className="contact-box">
          ...
          <form>
            ...
            <div>
            <p>Mail</p>
            <input type="Email" placeholder="Your Name" className="inp"/>
            </div>
            <div>
            <p>Message</p>
